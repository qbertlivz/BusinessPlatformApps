...
namespace FacebookUtillity
{
    public static class FacebookPageAnalyticsMetricGroups
    {
        ...
        public const string PageUserDemographicsMetrics = "page_fans,page_fans_locale,page_fans_city,page_fans_country,page_fans_gender_age,page_fan_adds,page_fan_adds_unique,page_fans_by_like_source,page_fans_by_like_source_unique,page_fans_group_by_like_source_unique,page_fan_removes,page_fan_removes_unique,page_fans_by_unlike_source_unique";
        public const string PageContentMetrics = "post_consumptions_by_type,page_consumptions_by_consumption_type,page_tab_views_login_top_unique,page_tab_views_login_top,page_tab_views_logout_top";
        ...
        public const string PagePostsMetrics = "page_posts_impressions,page_posts_impressions_unique,page_posts_impressions_paid,page_posts_impressions_paid_unique,page_posts_impressions_organic,page_posts_impressions_organic_unique,page_posts_impressions_viral,page_posts_impressions_viral_unique,page_posts_impressions_frequency_distribution,page_posts_impressions_by_paid_non_paid,page_posts_impressions_by_paid_non_paid_unique,post_interests_impressions,post_interests_impressions_unique,post_interests_consumptions_unique,post_interests_consumptions,post_interests_consumptions_by_type_unique,post_interests_consumptions_by_type,post_interests_action_by_type_unique,post_interests_action_by_type";
        ...
        public const string PagePostEngagementMetrics = "post_consumptions,post_consumptions_unique,post_consumptions_by_type,post_consumptions_by_type_unique,,post_negative_feedback,post_negative_feedback_unique,post_negative_feedback_by_type,post_negative_feedback_by_type_unique,post_engaged_fan,post_fan_reach,page_story_adds,page_story_adds_by_age_gender_unique,page_story_adds_by_city_unique,page_story_adds_by_country_unique";
        public const string PagePostReactionsMetrics = "post_reactions_by_type_total,post_stories_by_action_type,post_stories,page_storytellers,post_storytellers,post_stories_by_action_type,post_storytellers_by_action_type,post_engaged_users";
