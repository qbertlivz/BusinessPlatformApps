...
namespace FacebookUtillity
{
    public static class FacebookPageAnalyticsMetricGroups
    {
        ...
        public const string PagePostStoriesAndPeopleTalkingAboutThisMetrics = "page_stories,page_storytellers,page_stories_by_story_type,page_storytellers_by_story_type,page_storytellers_by_age_gender,page_storytellers_by_city,page_storytellers_by_country,page_storytellers_by_locale,post_stories,post_storytellers,post_stories_by_action_type,post_storytellers_by_action_type,post_story_adds,post_story_adds_unique,post_story_adds_by_action_type,post_story_adds_by_action_type_unique";
        ...
        public const string PageContentMetrics = "post_stories_by_action_type,post_consumptions_by_type,page_consumptions_by_consumption_type,page_tab_views_login_top_unique,page_tab_views_login_top,page_tab_views_logout_top";
        ...
        public const string PagePostEngagementMetrics = "post_consumptions,post_consumptions_unique,post_consumptions_by_type,post_consumptions_by_type_unique,post_engaged_users,post_negative_feedback,post_negative_feedback_unique,post_negative_feedback_by_type,post_negative_feedback_by_type_unique,post_engaged_fan,post_fan_reach,page_story_adds,page_story_adds_by_age_gender_unique,page_story_adds_by_city_unique,page_story_adds_by_country_unique";
        public const string PagePostReactionsMetrics = "post_reactions_by_type_total";
