...
namespace Microsoft.Deployment.Actions.AzureCustom.Common
{
    ...
    public class ExportActivityLogToEventHub : BaseAction
    {
        ...
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            string logProfileErrorDelete = await ahc.Test(HttpMethod.Delete, url);
            ...
            return string.IsNullOrEmpty(logProfileErrorPut)
                ...
                : new ActionResponse(ActionStatus.Failure, new ActionResponseExceptionDetail("ActivityLogsErrorExportingToEventHub", $"{logProfileErrorPut} ({logProfileErrorDelete})"));
        }
    }
}