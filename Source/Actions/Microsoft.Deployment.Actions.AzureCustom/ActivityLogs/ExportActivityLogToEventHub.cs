...
namespace Microsoft.Deployment.Actions.AzureCustom.Common
{
    ...
    public class ExportActivityLogToEventHub : BaseAction
    {
        ...
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            string nameLogProfile = RandomGenerator.GetRandomHexadecimal("bpst-al-lp-");
            ...
            string url = $"https://management.azure.com/subscriptions/{ba.IdSubscription}/providers/microsoft.insights/logprofiles/{nameLogProfile}?api-version=2016-03-01";

            AzureHttpClient ahc = new AzureHttpClient(ba.TokenAzure, ba.IdSubscription);

            string logProfileErrorPut = await ahc.Test(HttpMethod.Put, url, body);
