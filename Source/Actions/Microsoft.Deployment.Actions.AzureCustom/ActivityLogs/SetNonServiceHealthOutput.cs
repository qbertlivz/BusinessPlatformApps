...
namespace Microsoft.Deployment.Actions.AzureCustom.ActivityLogs
{
    ...
    public class SetNonServiceHealthOutput : BaseAction
    {
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var table = request.DataStore.GetValue("NonServiceHealthTable");
            var outputAlias = "NonServiceHealthOutput-" + RandomGenerator.GetRandomLowerCaseCharacters(5);
