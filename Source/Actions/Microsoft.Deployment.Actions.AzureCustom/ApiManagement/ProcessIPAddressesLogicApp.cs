...
namespace Microsoft.Deployment.Actions.AzureCustom.ApiManagement
{
    ...
    public class ProcessIPAddressesLogicApp : BaseAction
    {
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var armTemplate = JsonUtility.GetJObjectFromJsonString(System.IO.File.ReadAllText(Path.Combine(request.Info.App.AppFilePath, "Service/ARM/ProcessIPAddressesLogicApp.json")));
