...
namespace Microsoft.Deployment.Actions.AzureCustom.News
{
    ...
    public class DeployNewsTemplateHistorical : BaseAction
    {
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var armTemplate = JsonUtility.GetJObjectFromJsonString(System.IO.File.ReadAllText(Path.Combine(request.Info.App.AppFilePath, "Service/AzureArm/NewsTemplateHistorical.json")));
