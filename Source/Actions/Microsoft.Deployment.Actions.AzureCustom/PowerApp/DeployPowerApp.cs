...
namespace Microsoft.Deployment.Actions.AzureCustom.PowerApp
{
    ...
    public class DeployPowerApp : BaseAction
    {
        ...
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var response4 = await clientPA.ExecuteGenericRequestWithHeaderAsync(HttpMethod.Post, $"{CREATE_POWER_APPS_URL}/authoringsession/newinstance?requestedLocation=unitedstates", string.Empty);
