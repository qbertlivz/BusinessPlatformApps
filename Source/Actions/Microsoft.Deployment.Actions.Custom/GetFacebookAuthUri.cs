...
namespace Microsoft.Deployment.Actions.Custom
{
    ...
    public class GetFacebookAuthUri : BaseAction
    {
        public override async Task<ActionResponse> ExecuteActionAsync(ActionRequest request)
        {
            ...
            var authUri = "https://www.facebook.com/v2.10/dialog/oauth?client_id=" + clientId + "&redirect_uri=" + redirectUri + "&response_type=code&scope=manage_pages,pages_show_list,read_insights,read_audience_network_insights";
