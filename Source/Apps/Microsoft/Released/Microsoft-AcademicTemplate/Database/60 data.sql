...
Select @startDate = dateadd(yy, -6, dateadd(dd, 1-datepart(dy, getdate()), getdate()))
...
Begin
	...
	INSERT fb.[date] ([date_key], [full_date], [day_of_week], [day_num_in_month], [day_name], [day_abbrev]
