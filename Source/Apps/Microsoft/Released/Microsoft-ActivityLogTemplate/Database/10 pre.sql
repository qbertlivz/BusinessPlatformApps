...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='bpst_aal' AND TABLE_NAME='NonServiceHealthView' AND TABLE_TYPE='VIEW')
    DROP VIEW bpst_aal.NonServiceHealthView;
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='bpst_aal' AND TABLE_NAME='NonServiceHealthData' AND TABLE_TYPE='BASE TABLE')
    DROP TABLE bpst_aal.NonServiceHealthData;
