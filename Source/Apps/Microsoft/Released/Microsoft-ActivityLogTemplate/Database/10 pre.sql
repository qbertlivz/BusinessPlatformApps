...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='bpst_aal' AND TABLE_NAME='VerboseView' AND TABLE_TYPE='VIEW')
    DROP VIEW bpst_aal.VerboseView;
	
-- Tables
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='bpst_aal' AND TABLE_NAME='ActivityLogData' AND TABLE_TYPE='BASE TABLE')
    DROP TABLE bpst_aal.ActivityLogData;
