...
Begin
	...
	INSERT aal.[date] ([date_key], [full_date], [day_of_week], [day_num_in_month], [day_name], [day_abbrev]
...
*************************************/
INSERT aal.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'SalesManagement', N'FiscalMonthStart', N'1', 1);
INSERT aal.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'SalesManagement', N'version', N'1.0', 0);
INSERT aal.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'SalesManagement', N'SourceApplication', N'', 1);
INSERT aal.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'SalesManagement', N'BaseURL', N'', 1);
go