...
(
   ...
   parentbusinessunitidname                NVARCHAR(max) NULL,
   createdonbehalfby                       UNIQUEIDENTIFIER NULL,
   address2_addressid                      UNIQUEIDENTIFIER NULL,
...
(
  ...
  relatedobjectidname                     NVARCHAR(max) NULL,
  campaignidname                          NVARCHAR(max) NULL,
  pager                                   NVARCHAR(20) NULL,
  masterleadidyominame                    NVARCHAR(max) NULL,
  owningbusinessunit                      UNIQUEIDENTIFIER NULL,
  address2_stateorprovince                NVARCHAR(50) NULL,
  ...
  masterleadidname                        NVARCHAR(max) NULL,
  ownerid                                 UNIQUEIDENTIFIER NULL,
  address2_utcoffset                      INT NULL,
  address2_fax                            NVARCHAR(50) NULL,
  revenue_base                            DECIMAL(19, 4) NULL,
  ...
  qualifyingopportunityidname             NVARCHAR(max) NULL,
  address2_addressid                      UNIQUEIDENTIFIER NULL,
  ...
  originatingcaseidname                   NVARCHAR(max) NULL,
...
(
    ...
    subjectidname                NVARCHAR(max)  NULL,
    stageid                      UNIQUEIDENTIFIER NULL,
    ...
    SCRIBE_CREATEDON             DATETIME NOT NULL,
    SCRIBE_MODIFIEDON            DATETIME NOT NULL,
    CONSTRAINT pk_product PRIMARY KEY CLUSTERED (SCRIBE_ID)
);
CREATE NONCLUSTERED INDEX idx_parentproduct ON dbo.product(parentproductid) INCLUDE (SCRIBE_DELETEDON);
...
(
  ...
  address1_utcoffset                      INT NULL,
  msdyusd_usdconfigurationidname          NVARCHAR(max) NULL,
...
(
  ...
  modifiedonbehalfby         UNIQUEIDENTIFIER NULL,
  transactioncurrencyidname  NVARCHAR(max) NULL,
  manageridname              NVARCHAR(max) NULL,
  entityimage_timestamp      BIGINT NULL,
  ...
  modifiedon                 DATETIME NULL,
  exchangerate               DECIMAL(22, 10) NULL,
  manageridyominame          NVARCHAR(max) NULL,
  modifiedonbehalfbyyominame NVARCHAR(max) NULL,
  createdbyname              NVARCHAR(max) NULL,
  createdon                  DATETIME NULL,
  createdonbehalfbyname      NVARCHAR(max) NULL,
