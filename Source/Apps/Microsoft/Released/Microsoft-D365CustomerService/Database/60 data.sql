...
Begin
	...
	INSERT csrv.[date] ([date_key], [full_date], [day_of_week], [day_num_in_month], [day_name], [day_abbrev]
...
*************************************/
INSERT csrv.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'CustomerService', N'BaseURL', N'', 1);
go
