...
Begin
	...
	INSERT fso.[date] ([date_key], [full_date], [day_of_week], [day_num_in_month], [day_name], [day_abbrev]
...
*************************************/
INSERT fso.[configuration] (configuration_group, configuration_subgroup, [name], [value], [visible]) VALUES (N'SolutionTemplate', N'FieldService', N'BaseURL', N'', 1);
go
