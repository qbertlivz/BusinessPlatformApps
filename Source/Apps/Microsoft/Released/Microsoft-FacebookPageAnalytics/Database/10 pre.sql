...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='fbpa' AND TABLE_NAME='UsersView' AND TABLE_TYPE='VIEW')
    DROP VIEW fb.UsersView;
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='fbpa' AND TABLE_NAME='PagesView' AND TABLE_TYPE='VIEW')
    DROP VIEW fb.[PagesView];
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='fbpa' AND TABLE_NAME='EdgesView' AND TABLE_TYPE='VIEW')
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='fbpa' AND TABLE_NAME='STAGING_PagePostInfo' AND TABLE_TYPE='BASE TABLE')
    DROP TABLE fbpa.STAGING_PagePostInfo;
...
--IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='fbpa' AND ROUTINE_NAME='UpdateEdges' AND ROUTINE_TYPE='PROCEDURE')
