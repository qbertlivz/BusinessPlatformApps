...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='fb' AND TABLE_NAME='StagingInsert' AND TABLE_TYPE='BASE TABLE')
    DROP TABLE fb.StagingInsert;
