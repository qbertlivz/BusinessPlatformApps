...
export class Customize extends ViewModelBase {
    ...
    async NavigatingNext(): Promise<boolean> {
        if (!this.MS.UtilityService.isTargetListObjectPropertyUnique(this.entities, 'name')) {
            this.MS.ErrorService.message = this.MS.Translate.BYOE_CUSTOMIZE_UNIQUE_ENTITIES;
            return false;
        }
