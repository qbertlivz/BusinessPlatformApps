export const EN_US = {
    ...
    BYOE_CUSTOMIZE_SELECT_ENTITY: `Get started by adding a new entity or uploading a .csv file:`,
    BYOE_CUSTOMIZE_TITLE: `Customize Entities`,
    BYOE_CUSTOMIZE_UPLOAD_CSV: `Upload CSV`,
    ...
    COGNITIVE_SERVICES_CONFIRMATION: `I confirm I have read and understood the notice below.`,
    ...
    COGNITIVE_SERVICES_PRIVACY_1_B: `including the Microsoft Cognitive Services section.  You must comply with those terms, including the use and display requirements for the Bing Search APIs available`,
    ...
    INIT_D365_PSA_TITLE: `Professional Services for Dynamics 365`,
