export const EN_US = {
    ...
    INIT_AAL_DOWNLOAD: `IMPORTANT: Do not close this page until the tables below have loaded. Open the Power BI report (.pbix file) to analyze your Azure Activity Log. Publish the report for others to see in your Power BI workspace. You will need Power BI Desktop to open this file - download it`,
