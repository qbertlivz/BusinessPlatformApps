export const EN_US = {
    ...
    AZURE_STORAGE_CONTAINER: `Containers under Storage: `,
    AZURE_SUBSCRIPTION_STORAGE: `Storages under Subscription: `,
    ...
    INIT_GETTING_STARTED_AZURE_DATA_FACTORY: `Process imported data using Azure Data Factory`,
    INIT_GETTING_STARTED_AZURE_FUNCTION_BLOB_STORAGE: `Import Azure Blob Storage data into Azure SQL Database near real-time with Azure Function`,
    INIT_GETTING_STARTED_AZURE_IOT_CONTINUOUS_DATA_EXPORT: `Azure IoT Continuous Data Export enabled`,
    ...
    INIT_IOT_CDE_SELECT_STORAGE_TITLE: `Connect to your Azure Blob Storage`,
    INIT_IOT_CDE_SELECT_STORAGE_SUBTITLE: `Select the Azure Blob Storage that contains exported IoT Central data.`,
    INIT_IOT_CDE_SELECT_STORAGE_SUBTITLE2: `To learn how to set up continuous data export in IoT Central, check out`,
    ...
    INIT_SQL_SUBTITLE_IOT_CDE: `Set up a connection to SQL so we can bring in your exported Azure IoT Hub data.`,
