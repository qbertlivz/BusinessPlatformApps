export const EN_US = {
    ...
    INIT_AAL_TITLE: `Azure Activity Log`,
    ...
    INIT_ACTION_CONFIGURING_STREAM_ANALYTICS_OUTPUT: `Configuring Stream Analytics output as SQL`,
    ...
    INIT_SQL_SUBTITLE_AAL: `Set up a connection to SQL so we can bring in your Activity Log data.`,
