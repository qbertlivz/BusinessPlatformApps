export const EN_US = {
    ...
    DETAILS_REDDIT_PRIVACY_TOS1: `By using this Socialgist trial account, you agree to the `,
    DETAILS_REDDIT_PRIVACY_TITLE: `Reddit Privacy Policy`,
    DETAILS_REDDIT_PRIVACY_URL: `https://www.reddit.com/help/privacypolicy`,
    DETAILS_REDDIT_PRIVACY_TOS2: ` and the `,
    DETAILS_REDDIT_TRIAL: `To use this solution template you need a trial account with Socialgist. Enter your information below to register with Socialgist.  Microsoft may share the information you provide below with Socialgist and Reddit. The free trial will run until January 31st, 2018.  To extend service beyond the trial period please `,
    ...
    DETAILS_SOCIALGIST_TERMS_OF_SERVICE_TITLE: `Socialgist terms of service.`,
