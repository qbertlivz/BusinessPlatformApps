export const EN_US = {
    ...
    DETAILS_REDDIT_TRIAL: `To use this solution template you need a trial account with Socialgist. Enter your information below to register with Socialgist. The free trial will run until the end of January, 2018.  To extend service beyond the trial period please `,
    DETAILS_REDDIT_ACCEPT_TERMS1: `Yes, I accept the `,
    DETAILS_REDDIT_ACCEPT_TERMS2: ` and would like to hear from Socialgist about continuing service after the trial has ended.`,
