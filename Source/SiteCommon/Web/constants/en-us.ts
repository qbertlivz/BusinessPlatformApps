export const EN_US = {
    ...
    INIT_REDDIT_PRICING_COST: `By clicking next and deploying the template, you authorize Microsoft to create Azure resources on your subscription and bill based on their respective pricing rates.  Further, you acknowledge that this preview is made available with a free Socialgist API key that provides approved access to the Reddit API.  This key will expire on January 24th, 2018.  The approximate base cost of the Azure resources used by this template is $7 a day.  These costs are estimates only and subject to change.  After the preview period, an additional fee may be required to continue access to the Socialgist/Reddit API.`,
