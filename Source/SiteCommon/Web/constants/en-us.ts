export const EN_US = {
    ...
    AX_CUSTOM_URL: `If you can't find your AX instance in the dropdown, please enter it below:`,
    AX_LOGIN_CONFIRM: `Confirm connection`,
    AX_LOGIN_CONNECT: `Connect to D365`,
    AX_LOGIN_SUBTITLE: `To create the solution we require a connection to your Dynamics 365 for Operations instance.`,
    AX_INSTANCES: `Select your Dynamics for Operations instance:`,
    AX_TITLE: `Confirm connection to D365`,
    AX_SUBTITLE: `Confirm the connection to Dynamics 365 for Operations so we can start pulling data.`,
